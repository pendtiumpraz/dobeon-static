...
export default function Footer() {
  ...
  return (
    <footer className="bg-watercolor-brown border-t border-white/50 relative overflow-hidden">
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-primary-light/20 rounded-full blur-[100px] pointer-events-none translate-x-1/2 translate-y-1/2"></div>
      <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-secondary-light/30 rounded-full blur-[80px] pointer-events-none -translate-x-1/2 -translate-y-1/2"></div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-3">
              <a
                ...
                className="w-11 h-11 rounded-xl bg-white border border-gray-300 flex items-center justify-center text-gray-600 hover:border-primary hover:text-primary hover:bg-secondary-light/30 transition-all duration-300 hover:scale-110"
                aria-label="LinkedIn"
              >
