...
export default function Footer() {
  ...
  return (
    <footer className="bg-white/40 backdrop-blur-sm border-t border-white/50 relative overflow-hidden">
      <div className="absolute inset-0 watercolor-bg pointer-events-none opacity-20"></div>
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-20 max-w-7xl relative z-10">
        ...
        <div className="mb-16 pb-12 border-b border-gray-200">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:justify-end">
              <Link
                href="/contact"
                className="px-8 py-4 bg-gradient-to-r from-primary to-primary-dark text-white rounded-xl hover:shadow-2xl hover:shadow-primary/30 hover:-translate-y-0.5 transition-all duration-300 font-semibold text-center group inline-flex items-center justify-center gap-2"
              >
                Get Started Today
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="space-y-4 mb-8 flex flex-col items-center">
            <div className="flex items-center gap-3 text-gray-600 group text-center">
              <span className="text-sm">
                Sovereign Plaza, 12th Floor<br />
                Jl. TB Simatupang No.36, Cilandak,<br />
                South Jakarta, DKI Jakarta 12430
              </span>
            </div>

            <div className="flex gap-8 mt-4">
              <a href="mailto:contact@dobeon.com" className="flex items-center gap-2 text-gray-600 hover:text-primary transition-colors group">
              ...
              <a href="tel:+15551234567" className="flex items-center gap-2 text-gray-600 hover:text-primary transition-colors group">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex space-x-4">
            <a
              ...
              className="w-10 h-10 rounded-full bg-white border border-gray-300 flex items-center justify-center text-gray-600 hover:border-primary hover:text-primary hover:bg-secondary-light/30 transition-all duration-300 hover:scale-110"
              aria-label="LinkedIn"
            >
